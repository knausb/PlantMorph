...
attitude <- function( erect = 0, 
                      ...
                      ylim = c(0, 100),
                      ... ){
  graphics::plot( x = c(0,0), y = c(0,50), type = "l",
                 xlab = "", ylab = "",
                 xaxt = "n", yaxt = "n",
                 ylim = ylim)
...
#  lines( x = c(0,0), y = c(0,50) )
  ...
  if( !is.null(erect) ){
    graphics::text( x = 0, y = 50, labels = "erect", adj = c(0,0.5), srt = 90-erect )
  }
  
  if( !is.null(ascending) ){
    graphics::text( x = 0, y = 45, labels = "ascending", adj = c(0,0.5), srt = 90-ascending )
  }
  
  if( !is.null(spreading) ){
    graphics::text( x = 0, y = 40, labels = "spreading", adj = c(0,0.5), srt = 90-spreading )
  }
  
  if( !is.null(reflexed) ){
    graphics::text( x = 0, y = 35, labels = "reflexed", adj = c(0,0.5), srt = 90-reflexed )
  }
